...
"""
The language model task is to assign a probability for the likelihood of a given word 
(or a sequence of words) to follow a sequence of words.

For the language model task, any tokens on the future positions should be masked
"""
...
def generate_square_subsequent_mask(sz):
    """
        Generates an upper-triangular of matrix of -inf, with zeros on diag.
    """
...
class PositionalEncoding(nn.Module):
    ...
    def forward(self, x):
        """
        Args:
            x: Tensor, shape [seq_len, batch_size, embeeding_dim]
        """
